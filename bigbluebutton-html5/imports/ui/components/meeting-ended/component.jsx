...
import AudioRating from './audio-rating/component';
import VideoRating from './video-rating/component';
...
class MeetingEnded extends React.PureComponent {
  ...
  constructor(props) {
    ...
    this.setAudioSelectedStar = this.setAudioSelectedStar.bind(this);
    this.setVideoSelectedStar = this.setVideoSelectedStar.bind(this);
  ...
  setAudioSelectedStar(starNumber) {
    this.setState({
      audioSelected: starNumber,
    });
  }

  setVideoSelectedStar(starNumber) {
    this.setState({
      videoSelected: starNumber,
    });
  }
  ...
  sendFeedback() {
    ...
    if (audioSelected <= 0 && videoSelected <= 0) {
      logoutRouteHandler();
      return;
    }
    ...
    const message = {
      audioRating: audioSelected,
      videoRating: videoSelected,
      userId: Auth.userID,
      userName: fullname,
  ...
  render() {
    ...
    const noRating = audioSelected <= 0 && videoSelected <= 0;
          ...
          <div className={styles.content}>
            ...
            {this.shouldShowFeedback ? (
              <div>
                <AudioRating
                  total="5"
                  audioOnRate={this.setAudioSelectedStar}
                />
                <VideoRating
                  total="5"
                  videoOnRate={this.setVideoSelectedStar}
                />
                {!noRating ? (
                  <textarea
                    rows="5"
